...
👩‍💻 Golang backend-разработчик. В 2024 году перешла на Go, работаю в production-проектах: поддержка и развитие backend Telegram Mini App (Go, PostgreSQL, Redis, Gin, миграции, CI/CD).

Предыдущий опыт — более 10 лет в enterprise-разработке: интеграции, очереди сообщений (Kafka, RabbitMQ), работа с персональными и финансовыми данными, техническое руководство. Мой инженерный бекграунд позволяет подключаться к проектам без формализованных процессов и документации.
