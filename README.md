...
👩‍💻 Golang backend-разработчик. В 2025 году перешла на Go, работаю в production-проектах: поддержка и развитие backend Telegram Mini App (Go, PostgreSQL, Redis, Gin, миграции, CI/CD).
